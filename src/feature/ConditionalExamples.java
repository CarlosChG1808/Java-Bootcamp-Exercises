...
public class ConditionalExamples {
    ...
    public static void main(String[] args) {
        ...
        double resultado = 0;
        boolean operacionValida = true; // flag para saber si una operacion es valida
        ...
        if (monto <= 0){
            ...
            double montoConvetido = 0;
            boolean opcionValida = true;

            switch (opcion){
                case 1:
                    montoConvetido = monto * 3.96;
                    break;
                case 2:
                    montoConvetido = monto * 2.94;
                    break;
                case 3:
                    montoConvetido = monto * 3.55;
                    break;
                default:
            ...
            if (opcionValida){
                String calsificacion = (montoConvetido > 1000) ? "Alto": "Bajo";
                System.out.println("El monto convertido es: " +montoConvetido + "(" + calsificacion + ")");
            }
        }
